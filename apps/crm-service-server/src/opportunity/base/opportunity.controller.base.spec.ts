  ...
  test("POST /opportunities", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        expectedCloseDate: CREATE_RESULT.expectedCloseDate.toISOString(),
      ...
      .expect([
        {
          ...
          expectedCloseDate:
            FIND_MANY_RESULT[0].expectedCloseDate.toISOString(),
  ...
  test("GET /opportunities/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        expectedCloseDate: FIND_ONE_RESULT.expectedCloseDate.toISOString(),
